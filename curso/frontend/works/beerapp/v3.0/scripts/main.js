(function(){
  $("#table").hide();// hide the table
    ...
    $('#boton').on("click",function (e) {
        e.preventDefault();
        var query = $('input').val();
        beersApi.search(query,listBeers);// Here we call the beersapi object method search, placed in api.js
    ...
    $(document).on('click','tr',function(){//de otra forma no funciona
        ...
        beersApi.showDetails(idBeer,beerDetail); // Here we call the beersapi object method showDetails, placed in api.js
